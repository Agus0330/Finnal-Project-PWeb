...
<body>
    <div class="flex justify-center items-center h-screen bg-primary">
        <div class="w-96 p-6 shadow-lg bg-white rounded-md">
            ...
            <div class="mt-3">
                <label for="username" class="block text-base mb-2">No Handphone</label>
                <input type="text" id="username" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter Email / No HP" />
            </div>
            <div class="mt-3">
            ...
            <div class="mt-3 flex justify-between items-center">
                <div>
                    <a href="login.php" class="text-secondary font-semibold hover:text-primary">Already have account? Click here</a>
                </div>
            </div>
            <div class="mt-5">
                <button type="submit" class="border-2 border-primary bg-primary text-white py-1 w-full rounded-md hover:bg-transparent hover:text-primary font-semibold"><i class="fa-solid fa-right-to-bracket"></i>&nbsp;&nbsp;Register</button>
            </div>
        </div>
    </div>
